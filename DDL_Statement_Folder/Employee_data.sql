...
*/
-- Question 1: Show the first five thousand employees in the employees table (10 marks)
...
-- Question 2: Display all employee first names in alphabetical order (10 marks) 
...
-- Question 3: Show employees who have worked at the University the shortest amount of time (20 marks)
...
-- Question 4: Display the names of all employees whose age is a palindrome (20 marks) 
...
/* Question 5: Write a query to display all male and female employees who were not born in 1993 and who 
 will not receive a performance bonus (20 marks) */
